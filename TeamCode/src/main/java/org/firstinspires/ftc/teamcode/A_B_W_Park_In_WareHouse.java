...
@Disabled
@Autonomous(name = "A_B_W_Park_In_WareHouse", group = "Auton")
// @Autonomous(...) is the other common choice

public class A_B_W_Park_In_WareHouse extends OpMode {
    ...
    public void init() {
        ...
        robot.init();
        telemetry.addData("A_B_W_PARK_In_WareHouse", "Initialized");
    }
